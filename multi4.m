...
clear classes;
topDir = 'tmp2/';
trainC{1}  = {'h2',[],'ch4',1:19,'envs',1:10}; % CH4
testC{1} = {'h2',[],'ch4',1:19,'envs',20:30};
filePrefix{1} = 'ch4';

trainC{2}  = {'h2',[],'ethane',1:25,'envs',1:10}; %Ethane
testC{2} = {'h2',[],'ethane',1:25,'envs',15:25};
filePrefix{2} = 'c2h6';

trainC{3}  = {'h2',[],'ethylene',1:7,'envs',1:10}; %Ethylene
testC{3} = {'h2',[],'ethylene',1:7,'envs',20:30};
filePrefix{3} = 'c2h4z2';

trainC{4}  = {'h2',[],'ch4',1:7,'ethane',1:7,'envs',1:10}; %CH4(7 geom) + Ethane
testC{4} = {'h2',[],'ch4',1:7,'ethane',1:7,'envs',15:25};
filePrefix{4} = 'ch4-c2h6';

trainC{5}  = {'h2',[],'ch4',1:7,'ethane',1:7,'ethylene',1:7,'envs',1:10}; % CH4+Ethane + Ethylene
testC{5} = {'h2',[],'ch4',1:7,'ethane',1:7,'ethylene',1:7,'envs',20:30};
filePrefix{5} = 'ch4-c2h6-c2h4';

trainC{6}  = {'h2',[],'ch4',1:19,'ethane',1:7,'envs',1:10}; %Ch4(19 geom)+ Ethane
testC{6} = {'h2',[],'ch4',1:19,'ethane',1:7,'envs',20:30};
filePrefix{6} = 'ch4f-c2h6';

trainC{7}  = {'h2',[],'ch4',1:19,'ethane',1:7,'ethylene',1:7,'envs',1:10}; %CH4(19 geom)+ Ethane + Ethylene
...
for iC = 2
    for iPar = 1:4
        ...
        ftest = makeFitme(trainIn{:},commonIn{:},'enstruct1',en,'kestruct',ke);
